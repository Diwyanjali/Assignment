<template>
    ...
    <div class="container mx-auto">
            ...
            <div class="w-2/3">
                <div class="card">
                    <div class="card-body bg-blue-100">
                        <h4
                            class="card-title font-weight-bold text-lg text-center mb-4"
                        >
                            Add New Student
                        </h4>
                        ...
                        <form @submit.prevent="studentStore" class="form">
                            ...
                            <button
                                type="submit"
                                class="btn btn-primary mt-3 bg-sky-600"
                            >
                                Add Student
                            </button>
                        </form>
        ...
        <div class="mt-8">
            <h1 class="navbar-text h3 text-center fw-bold">Students List</h1>
            <br />
            <div>
                <div class="bg-white">
                    <table class="table">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                <input
                                    ...
                                    class="form-control"
                                    name="name"
                                    v-model="student_update_data.name"
                                    placeholder="Name"
                                />
                            </div>
                            <div class="mb-3">
                                <input
                                    ...
                                    class="form-control"
                                    name="age"
                                    v-model="student_update_data.age"
                                    placeholder="Age"
                                />
                            </div>
                            <div class="mb-3">
...
export default {
    ...
    methods: {
        ...
        async studentUpdate() {
            await axios.post(
                route("student.update", this.student_update_data.id),
